...
function v(b){return function(){var a=f(this).prev().val(),c=n(f(this).val()||"null"),d=f(this).parent(),e=d.data("path");m(b.original,(e?e+".":"")+a,c);if(j(c)||k(c)){l(b,c,d,(e?e+".":"")+a);p(d)}else d.find(".expander, .item").remove();r(d,c);s(this,b);b.onchange()}}function r(b,a){var c="null";if(j(a))c="object";else if(k(a))c="array";else if(Object.prototype.toString.call(a)=="[object Boolean]")c="boolean";else if(Object.prototype.toString.call(a)=="[object String]")c="string";else if(Object.prototype.toString.call(a)==
"[object Number]")c="number";b.removeClass(w);b.addClass(c)}f.fn.jsonEditor=function(b,a){a=a||{};var c,d=a.change||function(){};return this.each(function(){t(f(this),b,d,a.propertyElement,a.valueElement)})};var w="object array boolean number string null"})(jQuery);
